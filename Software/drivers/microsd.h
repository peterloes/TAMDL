 ...
 ***************************************************************************//**
Revision History:
2018-01-29,rage	Set MICROSD_PWR_GPIO_PORT and MICROSD_PWR_PIN for project TAMDL.
...
//@{
#define MICROSD_PWR_GPIO_PORT	gpioPortC	//!< Port for Power Enable
#define MICROSD_PWR_PIN		10		//!< Power Enable Pin
